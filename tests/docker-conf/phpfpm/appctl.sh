#!/bin/bash
ROOTDIR="/srv/booster.jelix.org"
TEMPDIR="$ROOTDIR/temp/"
APPDIR="$ROOTDIR/booster/"
APPTEMPDIR="$ROOTDIR/temp/booster"
...
case $COMMAND in
    clean_tmp)
        ...
        ;;
    reset)
        resetMysql $MYSQL_DATABASE $MYSQL_USER $MYSQL_PASSWORD
        resetMysql jelix_www $MYSQL_USER $MYSQL_PASSWORD
        resetJelixTemp $APPDIR $TEMPDIR $APPTEMPDIR
