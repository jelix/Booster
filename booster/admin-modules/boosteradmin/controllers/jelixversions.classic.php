...
class jelixversionsCtrl extends jControllerDaoCrud {

    protected $dao = 'booster~boo_jelix_versions';

    protected $form = 'boosteradmin~boo_jelix_versions';

    /**
     * the jDb profile to use with the dao
     */
    protected $dbProfile = 'booster';
   ...
   /**
    ...
    protected function _delete($id, $resp) {
        ...
        $countJelix = jDao::get('booster~boo_versions')->countExactJelixVersion($id);
        if ($countJelix > 0) {
